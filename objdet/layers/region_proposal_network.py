...
class ProposalTargetCreator(object):
    ...
    def __call__(self, roi, bbox, label,
        ...
        * :math:`L` is number of object classes possibly including the \
        ...
        iou = faster_rcnn_boxcoder.bbox_iou(roi, bbox)
        ...
        gt_roi_loc = faster_rcnn_boxcoder.bbox2loc(sample_roi, bbox[gt_assignment[keep_index]])
...
class AnchorTargetCreator(object):
    ...
    def __call__(self, bbox, anchor, img_size):
        ...
        * :math:`R` is the number of bounding boxes.
        ...
        loc = faster_rcnn_boxcoder.bbox2loc(anchor, bbox[argmax_ious])
    ...
    def _calc_ious(self, anchor, bbox, inside_index):
        ...
        ious = faster_rcnn_boxcoder.bbox_iou(anchor, bbox)
